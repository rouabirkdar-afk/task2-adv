...
const Faq = () => {
    return (
        <div className='faq-dis'>
            ...
            <Discriptios>Find all the essential information you need in our FAQ section, designed to address the most frequently asked questions and help you make informed decisions for your child's education.</Discriptios>
